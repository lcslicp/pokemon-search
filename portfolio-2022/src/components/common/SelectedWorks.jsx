...
const Selectedworks = () => {
  return (
    <section
      className='bg-black z-20 text-stone overflow-x-hidden'
      id='selectedworks'
    >
      ...
      <div className='flex flex-row flex-nowrap'>
        ...
        <div className='flex-none pt-72 pl-40 w-1/3'>
          ...
          <p className='text-sm font-normal pb-6'>
            Doowit is a personal task management app primarily used as a tool to
            sort and manage tasks with ease.
          </p>
          <a
